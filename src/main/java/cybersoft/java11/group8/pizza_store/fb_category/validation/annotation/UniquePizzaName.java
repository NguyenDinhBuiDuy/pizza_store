...
import cybersoft.java11.group8.pizza_store.fb_category.validation.validator.UniquePizzaNameValidator;

@Constraint(validatedBy = UniquePizzaNameValidator.class)
