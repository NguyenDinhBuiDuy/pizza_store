...
@Constraint(validatedBy = UniqueBeverageCodeValidator.class)
@Target({ ElementType.PARAMETER, ElementType.FIELD })
@Retention(RetentionPolicy.RUNTIME)
public @interface UniqueBeverageCode {
	public String message() default "beverage code is already used";
